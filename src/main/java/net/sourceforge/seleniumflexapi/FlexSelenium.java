...
public class FlexSelenium extends FlashSelenium {
	...
	public String setProperty(String objectId, String property, String newValue){
		return call("doFlexProperty", objectId + "." + property, newValue);
	}
	...
	public String getFlexDataGridData(String dataGridId) {
		String getFlexDataGridData = call("getFlexDataGridData", dataGridId, "");
		return getFlexDataGridData;
	}

	public JSONObject getFlexDataGridDataObject(String dataGridId) {
		String getFlexDataGridData = getFlexDataGridData(dataGridId);
		JSONObject jsonObject = new JSONObject(getFlexDataGridData);
		return jsonObject;
	}

	public JSONArray getFlexDataGridDataArray(String dataGridId) {
		String getFlexDataGridData = getFlexDataGridData(dataGridId);
		JSONArray jsonArray = new JSONArray(getFlexDataGridData);
		return jsonArray;
	}
